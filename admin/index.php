...
<div class="container-fluid">
  <div class="row">
      <div class="col-xs-8 col-xs-offset-2">
        ...
        <div class="form-group">
          <div class="col-xs-2">
            <label for="title" class="control-label">Contributor(s)</label>
          </div>
          <div class="col-xs-5">
            <select class="form-control" id="contributor" name="contributor" required="">
          ...
          <div class="col-xs-10 col-xs-offset-2"><button class="btn btn-danger">Add another contributor</button></div>
        </div>
